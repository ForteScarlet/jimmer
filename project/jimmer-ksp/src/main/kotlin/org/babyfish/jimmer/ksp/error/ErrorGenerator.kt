...
class ErrorGenerator(
    ...
    private val enumClassName = declaration.className()

    // private val declaredFieldsCache = mutableMapOf<KSDeclaration, Map<String, TypeName>>()
    private val declaredFieldsCache = mutableMapOf<KSDeclaration, Map<String, Any>>()

    // private val fieldsCache = mutableMapOf<KSClassDeclaration, Map<String, TypeName>>()
    private val fieldsCache = mutableMapOf<KSClassDeclaration, Map<String, Any>>()
    ...
    //     exceptionSimpleName
    // )
    private val exceptionClassName = declaration.packageName.asString() + "." + exceptionSimpleName
...
//                }.build()
    ...
    private fun KotlinFileBuilder.addMainType(superType: KClass<*>) {
        addSimpleClassType(exceptionSimpleName) {
            modifiers {
                abstract()
                // TODO: Add annotations and other modifiers
            }
        }
    }
